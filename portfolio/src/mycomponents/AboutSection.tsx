    ...
    <section id="about" className="py-16 bg-gray-50 dark:bg-gray-900">
      <div className="max-w-3xl mx-auto flex flex-col items-center px-4">
        ...
        <p className="text-lg text-gray-700 dark:text-gray-300 mb-4 text-center">
          Hi! I'm <span className="font-semibold text-blue-600 dark:text-blue-400">Sana Saifi</span>, a passionate developer with experience in building modern web applications using React, TypeScript, and Tailwind CSS.
        </p>
